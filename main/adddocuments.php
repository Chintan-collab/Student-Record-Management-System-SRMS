...
<li class = active><a href="adddocuments.php" style="
    color: black;
"><i class="fa fa-file" aria-hidden="true" style="font-size:30px; width: 30px;"></i></i> Add Documents</a>  </li>
  ...
  <center style="
    margin: 13px; color: black"><i class="fa fa-file" aria-hidden="true" style="font-size:30px; width: 30px;"></i></i> Add Documents </center>
			</div>
			<ul class="breadcrumb">
...
<a  href="index.php"><button class="btn btn-default btn-large" style="float: left; font-size: 18px; font-weight: 600; font-family: cursive; color: #518fd6; background-color: white;"><i class="icon icon-circle-arrow-left icon-large"></i> Back</button></a><form action="savedocument.php" method="post" enctype="multipart/form-data">
<center><h4><i class="icon-edit icon-large"></i> Add New Document	</h4></center>
<!-- <br> -->
<hr class="hr1">
<center>
<div id="ac">
...
<span style="width: 150px;    display: inline-block;text-align: left;font-family: monospace;font-weight: 600;color: black;font-size: 16px;">Title : </span><input type="text" style="width:265px; height:30px;"  name="title" Required /><br>
<span style="width: 150px;    display: inline-block;text-align: left;font-family: monospace;font-weight: 600;color: black;font-size: 16px;">Description : </span><input type="text" style="width:265px; height:30px;"  name="doc_description" Required /><br>
...
<span style="width: 153px;    display: inline-block;text-align: left;font-family: monospace;font-weight: 600;color: black;font-size: 16px;">College Year : </span><select name="iwy" style="width:265px; height:30px; margin-left:-5px;" >
...
<span style="width: 150px;    display: inline-block;text-align: left;font-family: monospace;font-weight: 600;color: black;font-size: 16px;">Document File : </span><input type="file" name="file" id="file" required style="width: 265px; height: 50px;" ><br><br>
<div >

<button class="btn btn-success btn-block btn-large" style="width:267px;     font-family: monospace; font-weight: 600;"><i class="icon icon-save icon-large" style="padding-right: 15px;"></i>Upload Document</button>
</div>
</div>
</form>
</center>
