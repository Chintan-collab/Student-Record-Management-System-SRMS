...
<input type="text" style="height:40px; color:#000; width: 50%;" name="filter" value="" id="filter" placeholder="Search Students..." autocomplete="off" />
...
<table class="hoverTable" id="resultTable" data-responsive="table" style="text-align: left;">
	<thead>
		<tr>
			<th width="5%" style= "background-color: #518fd6;;"><center> Student ID</center></th>
			<th width="9%" style= "background-color: #518fd6;;"><center> Full Name </center></th>
			<th width="2%" style= "background-color: #518fd6;;"><center> Gender</center> </th>
			<th width="5%" style= "background-color: #518fd6;;"><center> Academic Year</center></th>
			<th width="2%" style= "background-color: #518fd6;;"><center> Admission Year </center></th>
			<th width="3%" style= "background-color: #518fd6;;"><center> Parent Phone </center></th>
			<th width="12%" style= "background-color: #518fd6;;"><center> Action </center></th>
		</tr>
	</thead>
	<tbody>
...
<td><?php echo $row['student_id']; ?></td>
			...
			<a  title="Click to edit the Student" href="editstudent.php?id=<?php echo $row['id']; ?>"><button class="btn btn-warning btn-mini" style="width: 69px; margin-left: 10px; height: 25px;"><i class="icon-edit"></i> Edit</button> </a>
			<a  href="#" id="<?php echo $row['id']; ?>" class="delbutton" title="Click To Delete"><button class="btn btn-danger btn-mini" style="width: 69px; margin-left: 10px; height: 25px;"><i class="icon-trash"></i> Delete</button></a></td>
			</tr>
			<?php
				}
			?>	
